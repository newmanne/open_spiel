...
def dispatch_experiments(yml_config, base_job_name=None, game_name='parking_1', submit=True, mem=64, overrides='', cfr_also=False, database=True, n_seeds=1, start_seed=100):
...
def dispatch_br_database(experiment_name, run_name, t, br_player, configs, submit=True, mem=64, overrides=''):
...
def dispatch_eval_database(experiment_name, run_name, t, br_player, br_name, submit=True, mem=64, overrides=''):
    spiel_path, config_dir, pydir, manage_path = verify_config()
