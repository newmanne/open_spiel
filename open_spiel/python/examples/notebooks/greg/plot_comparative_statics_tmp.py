...
RESULTS_FNAME = 'cached_results_jan20_boring.csv'
...
def plot_metrics_by_game(df, metrics=None, fname='plot.png', straightforward=False):
    ...
    for i, metric in enumerate(metrics):
        ...
        dx = max((0.1 * (max_metric - min_metric)), 0.1)
...
if __name__ == '__main__':
    ...
    plot_metrics_by_game(df.query('n_types == 3 and rho == 1'), fname='comparative_statics.png')
